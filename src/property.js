 ...
 * @property {string} currentTemperature - Get current temperature from the internal (?) sensor (This value can not be set, only received. HVAC must support this feature otherwise null is returned)
